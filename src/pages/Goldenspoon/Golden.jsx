...
export default function Golden() {
    ...
    return (
      <>
        <h1>Golden Spoon Page</h1>
        <img src='https://s3-media0.fl.yelpcdn.com/bphoto/Qm2FBhz3md0dyzQbDQWNVA/l.jpg'></img>
        <h2>Classic American Steakhouse</h2>
        <p>For more than a decade, the chefs of Chops Grille have proudly presented quality, hand cut steaks at this hallmark Royal Caribbean restaurant. Now, they give you a fresh twist on a favorite, with a revamped menu that brings contemporary flair to traditional steakhouse offerings. Most intriguing: our exceptional prime meat. This prime beef is joined by Maine lobster, grilled branzino and other succulent dishes paired with addictive sides and irresistible desserts.</p>
        <h2>Menu Highlights</h2>
        <p>The best way to begin a meal at Chops Grille is with the charred beef carpaccio, sliced thin and served rare with fresh arugula, Parmesan cheese, and truffle mustard dressing.</p>
